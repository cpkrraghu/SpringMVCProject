			...
			<div class="col-sm-8">
				<div class="jumbotron" style="width: 50%; margin: 10% auto;">
						...
						<div class="form-group">
							<button class="btn btn-success" onclick="window.location.href='/employee'">Employee</button>
						</div>
						<div class="form-group">
							<button class="btn btn-success" onclick="window.location.href='/department'">Department</button>
						</div>
						<div class="form-group">
