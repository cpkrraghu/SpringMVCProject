...
public class EmployeeController {
	...
	public ModelAndView updateEmployee(@ModelAttribute Employee employee,@RequestParam int deptNoUpd,@RequestParam String pageType) throws SQLException {
	...
	public ModelAndView deletEmployee(@RequestParam("empNo") int empNo,@RequestParam int deptNo,@RequestParam String pageType) throws SQLException {
	...
	return model;
	 ...
	 public ModelAndView getEmployees(@RequestParam int deptNo) throws SQLException {
		 ...
		 if (emps.size()!=0){ 
			 ...
			 model.addObject("deptMsg", "No employees in given Department");
			 return model;
		 } 
	}
}
	 ...
	 /* 
	 * @ExceptionHandler(SQLException.class) public void
	 * handleUserNotFoundException(SQLException ex) {
	 * 
	 * }
	 */
